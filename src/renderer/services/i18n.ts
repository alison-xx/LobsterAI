...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    wordOriginalCopy: '查看编辑前副本',
    wordEditor: 'Word 文档编辑',
    wordToolbar: '文档格式',
    wordLoading: '正在打开 Word 文档…',
    wordSaved: '已自动保存',
    wordPending: '等待保存…',
    wordSaving: '正在保存…',
    wordConflict: '需要确认文件版本',
    wordSaveFailed: '保存失败',
    wordDraftSafe: '恢复副本已保留',
    wordTooLarge: '此文档超出当前编辑范围（文件 25 MB、解压后 100 MB）。',
    wordUnsupported: '此文档包含当前编辑器暂不支持的内容，可以预览或用系统应用打开。',
    wordAccessFailed: '无法访问或保存这个 Word 文档，请检查文件是否有效，以及是否有写入权限。',
    wordConflictHelp: '文件已被其他程序修改，自动保存已暂停。你的编辑仍保留在这里。',
    wordRecovered: '发现上次未保存的恢复副本。请确认保留这些编辑，或使用磁盘中的文件。',
    wordConfirmMine: '再次点击“保留我的编辑”将替换磁盘中的文件内容。',
    wordConfirmDisk: '再次点击“使用文件版本”将放弃当前未保存的编辑。',
    wordKeepMine: '保留我的编辑',
    wordUseDisk: '使用文件版本',
    wordDraftRetained: '恢复副本已保留，可以重试。',
    wordDraftUnsafe: '最新修改尚未备份，请保持应用打开并重试保存。',
    wordPreview: '预览文件',
    wordOpenExternal: '用系统应用打开',
    wordPage: '页',
    wordLocalFonts: '本地字体排版',
    wordFontNotice: '缺失的字体会使用内置字体替代，分页和外观可能与 Word 不同。',
    wordCommandRejected: '当前选区暂不支持此操作',
    wordStyle: '段落样式',
    wordFont: '字体',
    wordFontSize: '字号',
    wordUndo: '撤销',
  ...
  en: {
    wordOriginalCopy: 'Show original copy',
    wordEditor: 'Word document editor',
    wordToolbar: 'Document formatting',
    wordLoading: 'Opening Word document…',
    wordSaved: 'All changes saved',
    wordPending: 'Waiting to save…',
    wordSaving: 'Saving…',
    wordConflict: 'Choose a document version',
    wordSaveFailed: 'Save failed',
    wordDraftSafe: 'Recovery copy retained',
    wordTooLarge: 'This document exceeds the editing limits (25 MB file, 100 MB expanded).',
    wordUnsupported: 'This document contains content the editor cannot safely edit yet. Preview it or open it in your system app.',
    wordAccessFailed: 'Cannot access or save this Word document. Check that the file is valid and writable.',
    wordConflictHelp: 'The file changed in another program. Autosave is paused; your edits are still here.',
    wordRecovered: 'Recovered unsaved edits from a previous session. Choose whether to keep them or use the file on disk.',
    wordConfirmMine: 'Click “Keep my edits” again to replace the file contents on disk.',
    wordConfirmDisk: 'Click “Use file version” again to discard your unsaved edits.',
    wordKeepMine: 'Keep my edits',
    wordUseDisk: 'Use file version',
    wordDraftRetained: 'A recovery copy is retained. You can retry.',
    wordDraftUnsafe: 'Your latest edits are not backed up yet. Keep the app open and retry saving.',
    wordPreview: 'Preview file',
    wordOpenExternal: 'Open in system app',
    wordPage: 'Page',
    wordLocalFonts: 'Local fonts',
    wordFontNotice: 'Missing fonts use bundled substitutes. Pagination and appearance may differ from Word.',
    wordCommandRejected: 'This action is unavailable for the current selection',
    wordStyle: 'Paragraph style',
    wordFont: 'Font',
    wordFontSize: 'Font size',
    wordUndo: 'Undo',
    wordRedo: 'Redo',
    wordBold: 'Bold',
    wordItalic: 'Italic',
    wordUnderline: 'Underline',
    wordStrike: 'Strikethrough',
    wordAlignLeft: 'Align left',
    wordAlignCenter: 'Align center',
    wordAlignRight: 'Align right',
    wordAlignJustify: 'Justify',
    wordBullet: 'Bullet list',
    wordNumbered: 'Numbered list',
